                ...
                <div className="about">
                    ...
                    <div className="work-text">
                        <div className="work-card">
                            ...
                            <h2>Food Waste Reduction App</h2>
                            <p>
                                A web platform designed to raise awareness about
                                global food waste and inspire collective action.
                                It educates users on the impact of waste and
                        ...
                        <div className="work-card">
                            ...
                            <h2>ThreeJS 3D Text</h2>
                            <p>
                                A visually immersive 3D experience created with
                                Three.js. Users can explore a floating field of
                                torus shapes and 3D text by freely orbiting
                                around the scene, showcasing the possibilities
                                of WebGL and interactive graphics on the web.
                            </p>
                            <div className="tech-stack">
                        ...
                        <div className="work-card">
                            ...
                            <p>
                                An interactive platform that helps users stay
                                informed about global weather conditions. With
                                real-time data from the AccuWeather API, it
                                provides accurate forecasts, temperature trends,
                                and live updates for cities around the world.
                            </p>
                            <div className="tech-stack">
                                <span className="tech">HTML</span>
                                <span className="tech">CSS</span>
